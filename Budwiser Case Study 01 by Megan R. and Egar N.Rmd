...
#Given we imputed the Median into 1005 NAs in IBU here is the original data for comparison
...
set.seed(9850)
#Testing a 70 30 split to train
TestPercent = .7
...
Final Section Additional Analysis
...
#consumptionData %>% ggplot(aes(x = StateAbb, y = consumptionData$`Per capita `)) + geom_bar(stat = "identity", fill = "light green") + ylab("Per Capita Consumption of Beer in 1000s of Gallons") + ggtitle("Consumption of Beer Per Capita By State") + theme_clean()
